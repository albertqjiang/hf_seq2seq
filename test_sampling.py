...
if __name__ == "__main__":
    ...
    input_ids = tokenizer("summarize: proof (prove) goal: No subgoals!", return_tensors='jax', max_lenght=512, padding="max_length", truncation=True).input_ids
    non_zero = jnp.count_nonzero(input_ids)
    attention_mask = jnp.pad(jnp.ones(non_zero), (0, 512-non_zero))
